...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales and Recession Dashboard", style={'textAlign': 'center',
                                                               'color': '#503D36',
                                                               'font-size': '24'}),
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(average_sales,
                          ...
                          y='Automobile_Sales',
                          color='Vehicle_Type',
                          title='Average Sales of Vehicle Types during Recessions'))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(values=values, 
                          names=names, 
                          title="Total Ad Expenditure Share by Vehicle Type during Recessions")
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec = recession_data.groupby(['unemployment_rate', 'Vehicle_Type'])['Automobile_Sales'].sum().reset_index()
        R_chart4 = dcc.Graph(
        ...
        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'width': '50%', 'float': 'left'}),
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(
            ...
            title='Total Ad Expenditure of Each Vehicle Type in {}'.format(input_year)
        ))

#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(children=Y_chart1),html.Div(children=Y_chart2)],style={'width': '50%', 'float': 'left'}),
